// Generated from /Users/shubhamsingh/Desktop/MonoRepo/OpenData/OpenMetadata/openmetadata-spec/src/main/antlr4/org/openmetadata/schema/EntityLink.g4 by ANTLR 4.9.2
// jshint ignore: start
...
export default class EntityLinkParser extends antlr4.Parser {
    ...
    static ruleNames = [ "entitylink", "entity_type", "nameOrFqn", "entity_field", 
                         "separator" ];
	...
	nameOrFqn() {
	    let localctx = new NameOrFqnContext(this, this._ctx, this.state);
	    this.enterRule(localctx, 4, EntityLinkParser.RULE_nameOrFqn);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 40;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << EntityLinkParser.ENTITY_TYPE) | (1 << EntityLinkParser.ENTITY_FIELD) | (1 << EntityLinkParser.NAME_OR_FQN))) !== 0))) {
...
EntityLinkParser.RULE_nameOrFqn = 2;
...
class EntitylinkContext extends antlr4.ParserRuleContext {
	...
	nameOrFqn = function(i) {
	    if(i===undefined) {
	        i = null;
	    }
	    if(i===null) {
	        return this.getTypedRuleContexts(NameOrFqnContext);
	    } else {
	        return this.getTypedRuleContext(NameOrFqnContext,i);
	    }
	};
...
class NameOrFqnContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = EntityLinkParser.RULE_nameOrFqn;
    }
