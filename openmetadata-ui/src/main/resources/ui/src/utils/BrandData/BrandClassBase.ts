...
class BrandClassBase {
  public getMonogram() {
    return { 
      src: 'https://cdn.scalekit.com/dynamic-assets/us/env_104583980350703106/portal_customization_images/ast_108747844055203842.png',
      svg: Monogram 
    };
  }
  ...
  public getLogo() {
    return { 
      src: 'https://dev.neosapientai.com/mascot_logo_dark.svg',
      svg: Logo 
    };
  }
